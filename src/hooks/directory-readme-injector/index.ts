// Adapted from: docs/reference/hooks/directory-readme-injector/finder.ts, injector.ts, and storage.ts
// Adaptations:
...
export function createDirectoryReadmeInjector(): BuiltInHookHandler {
