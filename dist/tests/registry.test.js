...
import { sortDiagnostics } from "../src/core/diagnostics.js";
import { BUILT_IN_REGISTRY, selectRegistryEntries, validateRegistry } from "../src/core/registry.js";
describe("hook registry", () => {
    ...
    it("uses enableAllHooksByDefault without ignoring global disabled state", () => {
        ...
        assert.deepEqual(selectRegistryEntries(registry, baseEnvelope, { ...globallyDisabledConfig, enabled: true }), {
            entries: registry,
            diagnostics: []
        });
    });
...
function expectedUnknownHookDiagnostics() {
    return [
        {
            level: "error",
